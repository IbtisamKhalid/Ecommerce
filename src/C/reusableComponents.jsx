    ...
    <Box sx={{ display: "flex", flexDirection: "column" }}>
      ...
      <Box
        sx={{
          ...
          alignItems: "center",
          p: { xs: "0 1.5rem", sm: "0 2rem", md: "0 5rem", lg: "0 7rem" },
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
          ...
          <Typography variant="h6" component="div" sx={{ p: "0.8rem 0 1rem" }}>
            TrustBridge
          </Typography>
          <Box
            sx={{
        ...
        >
          <Button sx={{ color: "white", p: "1.3rem 1rem 1rem", m: "0.4rem 0" }}>
            Login
          </Button>
          <Button sx={{ color: "white", p: "1.3rem 1rem 1rem", m: "0.4rem 0" }}>
            SignUp
