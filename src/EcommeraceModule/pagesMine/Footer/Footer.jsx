  ...
  return (
    <Box mt="150px">
        ...
        <Container>
          ...
          >
            ...
            >
              ...
              <NewsletterSuccessDialog open={open} handleClose={handleClose} />
            </Box>
          </Box>
        </Container>
      </Box>}
      ...
      <Box
        sx={{
          bgcolor: Colors.primary,
          pb: isUserLoggedin ? 10 : 4,
          pt: isUserLoggedin ? 10  : 0,
          color: "white",
          position: "relative",
          zIndex: 0,
        }}
          ...
          <Grid container justifyContent={"center"}>
            <Grid item xs={12} textAlign={"center"}>
              ...
              <Box>
                ...
                <Button href="https://www.facebook.com/ibtisam.khalid.92" sx={{ mx: 1, color: "inherit" }}>
                  <Facebook />
                </Button>
                <Button href="https://www.instagram.com/ibtisamkhalid_/" sx={{ mx: 1, color: "inherit" }}>
                  <Instagram />
                </Button>
              </Box>
            </Grid>
