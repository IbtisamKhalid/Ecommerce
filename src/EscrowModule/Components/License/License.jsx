import {
  ...
  const SBPSvg = () => (
    <svg width="50" height="50" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="50" cy="50" r="40" stroke="black" strokeWidth="4" fill="#007bff" />
      <text x="50" y="55" textAnchor="middle" fontSize="14" fill="white">SBP</text>
    </svg>
  );
  
  const SECPSvg = () => (
    <svg width="50" height="50" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="10" y="10" width="80" height="80" stroke="black" strokeWidth="4" fill="#28a745" />
      <text x="50" y="55" textAnchor="middle" fontSize="14" fill="white">SECP</text>
    </svg>
  );
  
  const FBRSvg = () => (
    <svg width="50" height="50" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      <polygon points="50,10 90,80 10,80" stroke="black" strokeWidth="4" fill="#ffc107" />
      <text x="50" y="65" textAnchor="middle" fontSize="14" fill="black">FBR</text>
    </svg>
  );
  ...
  const License = () => {
    ...
    return (
      <Box sx={{ padding: "2rem" }}>
        <Typography variant="h4" sx={{ textAlign: "center", marginBottom: "1.5rem", fontWeight: "bold" }}>
          ...
          {licenses.map((license) => (
            <Grid item key={license.id} size={{ xs: 12, sm: 12, md: 4 }}>
              <Tooltip title="Click to verify" followCursor>
                <Card
                  sx={{ textAlign: "center", padding: "1rem", boxShadow: 1, cursor: "pointer" }}
                ...
                >
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" sx={{ fontWeight: "bold", marginTop: "0.5rem" }}>
